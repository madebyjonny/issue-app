...
<body class="font-sans antialiased bg-gray-50 text-gray-700 flex items-center justify-center min-h-screen">
    <div class="text-center max-w-md px-6">
        ...
        <div class="flex items-center justify-center gap-4">
            ...
            <a href="{{ route('register') }}" class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 font-medium rounded-lg transition">Create account</a>
        </div>
    </div>
</body>
</html>
